...
export function renderChordDiagramSvgWithData(chordName, data, large = false) {
  ...
  const positionBadge = baseFret > 1
    ? `<rect x="0" y="20" width="16" height="36" rx="6" fill="#1f1f1f" stroke="#5a5a5a" stroke-width="1.2"/><text x="10" y="46.5" text-anchor="end" fill="#f2f2f2" font-size="24" font-weight="500">${baseFret}</text>`
    : '';
  return `
